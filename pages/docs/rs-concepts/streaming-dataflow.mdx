...
The basic premise of [streaming dataflow](https://en.wikipedia.org/wiki/Stream_processing) is that a [series of operations](/docs/streaming-dataflow#operations) is applied to each element of a [stream](/docs/streaming-dataflow#stream) (a given sequence of data).
...
![Graph](/Users/zolmes/readyset-public-docs/readyset-public-docs/public/high-level-graph.png)