...
The basic premise of [streaming dataflow](https://en.wikipedia.org/wiki/Stream_processing) is that a [series of operations](/docs/rs-concepts/streaming-dataflow#operations) is applied to each element of a [stream](/docs/rs-concepts/streaming-dataflow#stream) (a given sequence of data).
...
![Graph](/readyset-public-docs/readyset-public-docs/public/high-level-graph.png)