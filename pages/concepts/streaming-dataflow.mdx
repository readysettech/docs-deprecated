...
The basic premise of [streaming dataflow](https://en.wikipedia.org/wiki/Stream_processing) is that a [series of operations](/concepts/advanced-concepts/streaming-dataflow#operations) is applied to each element of a [stream](/concepts/advanced-concepts/streaming-dataflow#stream) (a given sequence of data).
