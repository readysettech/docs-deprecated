...
## Can I try it? 
Yes! ReadySet is source-available under the BSL 1.1 license and is free for production use on a single node. 
Check out our [Github](https://github.com/readysettech/readyset) for more info. 