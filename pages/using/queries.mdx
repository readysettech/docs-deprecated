...
Support for additional operators is always expanding! Reach out to us in [Slack](https://readysetcommunity.slack.com/) if you need an unsupported feature and we'll look into it.
...
These limitations does not apply when the right-hand side of the `IN` clause does not contain any query parameters.  
