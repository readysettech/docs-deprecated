...
<Callout type="warning">Beta versions of ReadySet are backward-incompatible. To upgrade between beta versions, you must therefore clear all data files. Rolling upgrades will be supported with future ReadySet major releases.</Callout>

## beta-2023-06-29

### Downloads
<Tabs items={['Docker', 'Source']}>
<Tab>
...
<Tab>
<Callout type="info">This release does not include pre-built binaries. However, you can build binaries from source. For guidance, see the ReadySet [README](https://github.com/readysettech/readyset#development):</Callout>
...
### Downloads
<Tabs items={['Linux', 'Mac', 'Docker', 'Source']}>
<Tab>
<Callout type="info"> ReadySet binaries for Linux require the OpenSSL 1.1.x package. OpenSSL 3.x+ is not currently supported.</Callout>
...
<Tab>
    - ReadySet Server (linux-x84_64)
        ...
        ```
<Callout type="error">ReadySet Adapter images may be broken on certain Mac platforms in this release!</Callout>
