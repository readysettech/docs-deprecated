...
<Callout> The easiest way to determine whether your queries are supported is to run them against ReadySet and check the output of [`SHOW PROXIED QUERIES`](/get-started/cache/creating-a-cache). </Callout> 
## Query Structure
