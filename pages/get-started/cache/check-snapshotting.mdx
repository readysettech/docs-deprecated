...
<Callout type="info">The frequency of these progress messages is controlled by the [`--snapshot-report-interval-secs`](/reference/cli/readyset#--snapshot-report-interval-secs) CLI option.</Callout>