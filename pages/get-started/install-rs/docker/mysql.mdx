...
Ensure your database and user are configured for Readyset to operate by following the [database reference documentation](/reference/configure-your-database/mysql/generic-db-directions).
...
Alternatively, you can log into the Readyset [shell](/get-started/connect/connect-via-database-shell) and run
