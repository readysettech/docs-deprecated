...
**By default, ReadySet will import all tables.** If this is what you want, you can skip passing in this argument. 
...
As you can see above, ReadySet is set to listen on port 5433. All `-e` environment variables can be 
