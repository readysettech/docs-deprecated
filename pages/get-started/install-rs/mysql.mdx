...
If this is what you want, you can skip passing in this argument. 

If you'd like to import all of the tables in a given schema, you can specify that as follows: ```<schema>.*```. 
...
ReadySet will then connect to your database and replicate the specified tables. Depending on how large these tables
