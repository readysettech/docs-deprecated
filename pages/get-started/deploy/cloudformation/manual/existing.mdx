...
#### If you have an existing Consul cluster you would like to use, make sure that your existing Consul cluster can be used by ReadySet:
...
#### If you don’t already have a Consul cluster, then you can set one up by launching this ReadySet-provided Consul stack.
...
## Connect ReadySet to your primary database
...
**Step 2: Once you have the `ReadySetDBSecurityGroup`, go to the AWS RDS console:**
