...
When prompted, please provide a name for your new database. You will then be prompted for a password. In unix style fashion, your password will not be displayed back to you for security purposes. Simply hit enter when finished typing and you will be prompted to confirm your chosen database password.
