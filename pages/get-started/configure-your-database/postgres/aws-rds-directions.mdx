...
Modify DB instance.
5. To check that this worked, run the following command:
...
When you initially set up your RDS instance, you created an [admin user and password](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_SettingUp.html#sign-up-for-aws). If you use this admin user / password during your ReadySet set up process, you will not need to enable superuser permissions.
