...
The easiest way to determine which queries are supported is to refer to the ReadySet dashboard, which will display information about whether individual queries are supported by ReadySet for you.
