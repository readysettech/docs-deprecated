...
Once you have a ReadySet cluster up and running, the next step is to connect your application to the cluster. To connect, you will need to replace your application’s database connection string with a URL to connect to the ReadySet adapter. This will be different based on the third party ORM and development language you are using.
...
In this case, Database URL is an environment variable with the following format.
...
where Database URL is an environment variable with the following format.
