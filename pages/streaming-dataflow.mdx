...
The basic premise of [streaming dataflow](https://en.wikipedia.org/wiki/Stream_processing) is that a [series of operations](/streaming-dataflow#operations) is applied to each element of a [stream](/streaming-dataflow#stream) (a given sequence of data).
